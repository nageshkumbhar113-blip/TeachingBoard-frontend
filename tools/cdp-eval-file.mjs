// node tools/cdp-eval-file.mjs <port> <jsFilePath>
// Evaluates the given JS file's content directly in the page (for hot-patching
// a running WebView without a full APK rebuild).
